<?php
// SMSC.RU API (smsc.ru) ������ 3.7 (09.10.2017)

define("SMSC_LOGIN", "turboinsta");			// логин клиента
define("SMSC_PASSWORD", "6da417b7f9e9fcbb989890c3353a62b2");	// пароль или MD5-хеш пароля в нижнем регистре
